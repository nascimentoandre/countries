...
export default function Home( {match} ) {
    ...
    const countriesFiltRegion = countries.filter(c => {
        return c.region === match.params.reg;
    })

    console.log(countriesFiltRegion);
    ...
    const filteredCountries = countriesFiltRegion.filter(country => {
